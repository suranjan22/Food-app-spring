...
<head>
  ...
  <title>Restaurant Login</title> <%-- Changed title --%>
...
<body>
  ...
  <div class="container">
    <h2>Restaurant Login</h2> <%-- Changed heading --%>
    ...
    <form action="/restrologin" method="post"> <%-- IMPORTANT: Add action and method --%>
      <div class="form-group">
        <label for="email">Email or Username</label>
        <input type="text" id="email" name="email" placeholder="Enter your email or username" required> <%-- Added name attribute --%>
      </div>
      ...
      <div class="link">
        Don't have an account? <a href="\restrosignup">Sign Up</a>
      </div>
    </form>
  </div>
</body>
